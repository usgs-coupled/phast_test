...
static grid *
grid_create(double xmin, double xmax, double ymin, double ymax, int nx,
			int ny)
{
	grid *g = NULL;
...
preader *
preader_create1(double xmin, double xmax, double ymin, double ymax, int nx,
				int ny)
{
