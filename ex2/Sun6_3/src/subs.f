...
C
     ...
     1        1.138641541510501556495D02,3.161123743870565596947D0,
     2        1.857777061846031526730D-01/
      DATA Q1/2.844236833439170622273D03,1.282616526077372275645D03,
     1        2.440246379344441733056D02,2.360129095234412093499D01,
     2        1.0D0 /
      DATA P2/1.23033935479799725272D03,2.05107837782607146532D03,
     1        1.71204761263407058314D03,8.81952221241769090411D02,
     2        2.98635138197400131132D02,6.61191906371416294775D01,
     3       8.88314979438837594118D00,5.64188496988670089180D-01,
     4       2.15311535474403846343D-08/
      DATA Q2/1.23033935480374942043D03,3.43936767414372163696D03,
     1        4.36261909014324715820D03,3.29079923573345962678D03,
     2        1.62138957456669018874D03,5.37181101862009857509D02,
     3        1.17693950891312499305D02,1.57449261107098347253D01,
     4        1.0D0 /
      DATA P3/-6.58749161529837803157D-04,-1.60837851487422766278D-02,
     1        -1.25781726111229246204D-01,-3.60344899949804439429D-01,
     2        -3.05326634961232344035D-01,-1.63153871373020978498D-02/
      DATA Q3/2.33520497626869185443D-03,6.05183413124413191178D-02,
     1        5.27905102951428412248D-01,1.87295284992346047209D00,
     2        2.56852019228982242072D00,1.0D0/
C
...
C
      IN2=77
      OPEN(IN2,FILE='src/glq.pts',STATUS='OLD')
C
...
201   FORMAT(TR20,'*****  ERROR IN ROUTINE GLQPTS  *****'/
     1 TR20,'NO. OF ROOTS SPECIFIED MUST EQUAL 4,20,60,104 OR 256')
      END
C
C       ******************************************************
C      *                                                      *
...
C        CARDS UNTIL IT ENCOUNTERS AN '=' IN COLUMN 1. THE FIRST 1
...
C       FORMAT STATEMENTS
 ...
 203   FORMAT(TR16,1H*,66X,1H*/TR16,1H*,12X,'PROGRAM RUN ON ',
     1 A16,' AT ',A8,11X,1H*/TR16,1H*,66X,1H*/TR16,68(1H*)
     2 /)
       END
C
C       ******************************************************
