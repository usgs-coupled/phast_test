...
!> @brief Fortran Documentation
!> USE PhreeqcRM defines the PhreeqcRM Fortran subroutines in a Fortran file.
!> For Windows, define the module by including the file RM_interface.F90 in your project.
!> For Linux, configure, compile, and install PhreeqcRM. You will need to include the
!> include directory from the installation to be able to compile your code using the module.
