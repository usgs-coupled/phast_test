...
/* ---------------------------------------------------------------------- */
void
buffer_to_hst(double *first, int dim)
/* ---------------------------------------------------------------------- */
/*
 *   Puts boundary conditions for same component every dim position
 */
...
/* ---------------------------------------------------------------------- */
void
moles_to_hst(double *first, int dim)
/* ---------------------------------------------------------------------- */
/*
 *   Puts boundary conditions for same component every dim position
 */
...
/* ---------------------------------------------------------------------- */
void
hst_to_buffer(double *first, int dim)
/* ---------------------------------------------------------------------- */
/*
 *   Pulls out solution composition for a single cell
 */
...
/* ---------------------------------------------------------------------- */
void
hst_moles_to_buffer(double *first, int dim)
/* ---------------------------------------------------------------------- */
/*
 *   Pulls out solution composition for a single cell
 */
...
/* ---------------------------------------------------------------------- */
int
xs_s_assemblage_save_hst(int n)
/* ---------------------------------------------------------------------- */
{
/*
...
/* ---------------------------------------------------------------------- */
int
print_using_hst(int cell_number)
/* ---------------------------------------------------------------------- */
{
/*
