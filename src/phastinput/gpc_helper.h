...
gpc_polygon *triangle(double x1, double y1, double x2, double y2, double x3,
					  double y3);

bool line_and_segment_intersection(Point p1, Point p2, Point q1, Point q2,
								   std::vector < Point > &intersection);
bool line_intersect_polygon(Point ray1, Point ray2, std::vector < Point > pts,
