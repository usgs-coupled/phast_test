...
typedef enum
{ PT_MIX, PT_DOUBLE, PT_INTEGER } property_type;
#define UNDEFINED 2
#define TRUE 1
#define FALSE 0
#define OK 1
...
EXTERNAL double area_tolerance;
...
struct cell
{
	...
	std::vector <
	River_Polygon > *
		drain_polygons;			// all segments attached to uppermost cell
	std::vector <
	River_Polygon > *
	...
	int
		drain_starting_segment_fortran;
	int
		leaky_starting_segment_fortran;
	int
		flux_starting_segment_fortran;
...
EXTERNAL struct cunits
	units;
EXTERNAL struct Head_ic **
	head_ic;
EXTERNAL int
	count_head_ic;
EXTERNAL struct chem_ic **
	chem_ic;
EXTERNAL int
	count_chem_ic;
EXTERNAL struct BC **
...
EXTERNAL struct print_zones_struct
	print_zones_xyz,
	print_zones_chem;
...
EXTERNAL size_t
	...
	count_flux,
	count_leaky,
	count_river_segments,
	count_drain_segments;
...
EXTERNAL struct time
	current_print_bc_flow;
EXTERNAL struct time
	current_print_conductances;
EXTERNAL int
	current_print_bc;
EXTERNAL int
	current_print_end_of_period;
EXTERNAL struct time
	current_print_restart;
EXTERNAL struct time
...
EXTERNAL int
	print_input_wells;
EXTERNAL int
	print_input_xyz_wells;
EXTERNAL int
	print_input_xy;

EXTERNAL int
	print_input_force_chem;
EXTERNAL int
	print_input_comp;
EXTERNAL int
	print_input_xyz_comp;
EXTERNAL int
	print_input_head;
EXTERNAL int
	print_input_xyz_head;
EXTERNAL int
	print_input_ss_vel;
EXTERNAL int
	print_input_ss_vel_defined;
EXTERNAL int
	print_input_xyz_ss_vel;
EXTERNAL int
	print_input_xyz_ss_vel_defined;
EXTERNAL int
	print_input_hdf_chem;
EXTERNAL int
	print_input_hdf_head;
EXTERNAL int
	print_input_hdf_ss_vel;
EXTERNAL int
